document.addEventListener('DOMContentLoaded', async function () {
    ...
    profileEditForm.addEventListener('submit', async function(event) {
        ...
        const isPublic = document.querySelector('input[name="is_public"]:checked').value;
        const sessionCheckboxes = document.querySelectorAll('input[name="session[]"]:checked');
        const checkedSessions = Array.from(sessionCheckboxes).map(checkbox => checkbox.value);
